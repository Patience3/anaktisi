...
interface CreateVideoContentPageProps {
    params: {
        programId: string;
        moduleId: string;
    };
...
export default function CreateVideoContentPage({ params }: CreateVideoContentPageProps) {
    ...
    const handleSuccess = (content: ContentItem) => {
        toast({
            ...
            description: "The video content has been successfully added.",
        });
    ...
    return (
        <div className="container mx-auto max-w-3xl">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl">Add Video Content</CardTitle>
                    <CardDescription>
                        Add a video to this module
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <VideoContentForm
